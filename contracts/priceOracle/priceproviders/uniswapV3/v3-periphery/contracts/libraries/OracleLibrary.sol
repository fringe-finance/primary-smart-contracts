...
library OracleLibrary {
    ...
    function consult(address pool, uint32 period) internal view returns (int24 timeWeightedAverageTick) {
        ...
        if (tickCumulativesDelta < 0 && (tickCumulativesDelta %  int32(period) != 0)) timeWeightedAverageTick--;
    }
    ...
    function getBlockStartingTick(address pool) internal view returns (int24) {
        ...
        require(prevInitialized, 'ONI');
         ...
         return int24((tickCumulative - prevTickCumulative) / int32((observationTimestamp - prevObservationTimestamp)));
    }
}