 ...
 */
contract PriceProviderAggregatorV3 is Initializable, AccessControlUpgradeable {
    ...
    function setPrimaryLendingPlatform(address plp) external onlyModerator {
        ...
        primaryLendingPlatform = IPrimaryLendingPlatformV3(plp);
    ...
    function getReportedPrice(address token) external view returns (uint256 price) {
        return priceOracle.getReportedPrice(token);
    }
