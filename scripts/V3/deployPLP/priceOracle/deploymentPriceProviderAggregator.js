...
module.exports = {
    ...
    deploymentPriceOracle: async function () {
        ...
        PriceProviderAggregator = await hre.ethers.getContractFactory("PriceProviderAggregatorPythV3");
        ...
        erc4626PriceProviderImplementation = LPPriceProvider.attach(erc4626PriceProviderLogicAddress).connect(deployMaster);
