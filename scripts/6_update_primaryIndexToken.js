...
module.exports = async function (deployer,network,accounts) {
    ...
    let proxyAdminAddressStage = '0x91976Ac128B93B21374ecf3A3dD224AEcB1C746A';
    let proxyAdminAddressDev = '0x436335D964C49FEbd47cda35d2b9499fB7eD9e8B';
    let proxyAdminStage = await ProxyAdmin.at(proxyAdminAddressStage);
    let proxyAdminDev = await ProxyAdmin.at(proxyAdminAddressDev);
//============================================================================
    ...
    // });
    // let primaryIndexTokenProxyAddressStage = '0xA30e247C55C5Fe941FE6790Fe903fB382b06331B';
    // let primaryIndexTokenProxyAddressDev = '0x908d17d8fD57Bc83F9197ab841782C675996650C';
    
    // await proxyAdminStage.upgrade(primaryIndexTokenProxyAddressStage,primaryIndexTokenMasterCopyAddress,{from:deployMaster}).then(function(){
    //     console.log("Proxy admin upgraded primaryIndexToken at "+primaryIndexTokenProxyAddressStage);
    // });

    // await proxyAdminDev.upgrade(primaryIndexTokenProxyAddressDev,primaryIndexTokenMasterCopyAddress,{from:deployMaster}).then(function(){
    //     console.log("Proxy admin upgraded primaryIndexToken at "+primaryIndexTokenProxyAddressDev);
    // });
