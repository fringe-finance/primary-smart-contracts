...
const sellOnDex = (tokenIn, tokenInDecimals, tokenInAmount, tokenOut, swapOnDex, maxDiscrepancy, receiver, chainId, signerOrProvider) => __awaiter(void 0, void 0, void 0, function* () {
    if (swapOnDex === dexType_1.Dex.Paraswap) {
        ...
        return yield (0, sellOnParaswap_1.sellOnParaswap)(tokenIn, tokenInDecimals, tokenInAmount, tokenOut, tokenOutDecimals, receiver, chainId, maxDiscrepancy);
    }
