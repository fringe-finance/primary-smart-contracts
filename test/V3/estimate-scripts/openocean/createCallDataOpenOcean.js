...
const createCallDataOpenOcean = (srcToken_1, srcDecimals_1, srcAmount_1, destToken_1, _a, gasPriceInGWei_1) => __awaiter(void 0, [srcToken_1, srcDecimals_1, srcAmount_1, destToken_1, _a, gasPriceInGWei_1], void 0, function* (srcToken, srcDecimals, srcAmount, destToken, { chainId = "1", account }, gasPriceInGWei) {
    var _b;
    ...
    let data = "";
    let amount = 0;
    if ((_b = priceData === null || priceData === void 0 ? void 0 : priceData.data) === null || _b === void 0 ? void 0 : _b.data) {
