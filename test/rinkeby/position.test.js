...
describe("Tests for PrimaryIndexToken contract", async function () {
    ...
    describe("PrimaryIndexToken ", async function(){
        ...
        describe("Borrow and Repay by one borrow position by PRJ1 collateral", async function(){
            ...
            it("Get borrower position", async function(){
                await printSeparator();

                let position = await pit.connect(deployMaster).getPosition(borrowerAddress, prj1Address, usdcAddress);
            ...
            it("Mine 100 blocks", async function(){
