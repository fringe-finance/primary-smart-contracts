...
const unwrap = (pair, amount, pairType, signer) => __awaiter(void 0, void 0, void 0, function* () {
    const pairInstance = (0, loadPairInstance_1.loadPairInstance)(pair, pairType, signer);
