...
describe("PrimaryLendingPlatformAtomicRepayment", function () {
    ...
    describe("repayAtomic", async function () {
        ...
        it.skip("17. Failure: Should revert when healthFactor < 1, isLeveragePosition == TRUE, depositedProjectTokenAmount < collateralAmount and afterLendingBalance of PLPAtomicRepayment contract == 0", async function () {
            await loadFixture();
            ...
            let isRepayFully = false;
            {
                ...
                );
                {
                    ...
                    exp = await plpInstance.getTokenEvaluation(lendingToken, availableToBorrow);
                    ...
                    await usdc.connect(deployMaster).approve(plpLeverageInstance.address, availableToBorrow);
