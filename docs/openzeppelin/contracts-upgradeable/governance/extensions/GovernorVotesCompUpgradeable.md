...
*Extension of {Governor} for voting weight extraction from a Comp token. _Available since v4.3._*
...
```solidity
function token() external view returns (contract ERC20VotesCompUpgradeable)
```
...
| Name | Type | Description |
|---|---|---|
| _0 | contract ERC20VotesCompUpgradeable | undefined |
